...
for name, model in base_estimators:
    ...
    print(f"✓ AUC: {auc:.4f}, Acc: {accuracy:.4f}")
...
print(f"✓ Acc: {acc_slr:.4f}, AUC: {auc_slr:.4f}")
...
print(f"✓ Acc: {acc_sgb:.4f}, AUC: {auc_sgb:.4f}")
...
if best_ensemble['AUC-ROC'] > prev_best_auc:
    ...
    print(f"\n✓ Previous model is still better by {-improvement:.2f} percentage points")
...
if save_new_model:
    ...
    print(f"✓ Ensemble models saved for reference")
